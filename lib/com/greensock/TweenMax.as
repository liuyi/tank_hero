...
//---- STATIC FUNCTIONS -----------------------------------------------------------------------------------------------------------
		 ...
		 */
		public static function to(target:Object, duration:Number, vars:Object,ignoreTarget:Boolean=true):TweenMax {
			if(target==null){
		 ...
		 * @return TweenMax instance
		 */
		public static function from(target:Object, duration:Number, vars:Object,ignoreTarget:Boolean=true):TweenMax {
			if(target==null){
				if(!ignoreTarget)  throw new Error("Cannot tween a null object.");
				else return null;
			}
