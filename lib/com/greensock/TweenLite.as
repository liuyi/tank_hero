...
//---- STATIC FUNCTIONS -----------------------------------------------------------------------------------
		 ...
		 * 
		 * * modified by liu yi, added a ignoreTarget param, because some time the target was removed from stage, then trigger this. 
		 * if(!ignoreTarget)
					throw new Error("Cannot tween a null object.");
				else 
					return;
		 ...
		 */
		public static function to(target:Object, duration:Number, vars:Object,ignoreTarget:Boolean=true):TweenLite {
			
			if(target==null){
				if(!ignoreTarget)  throw new Error("Cannot tween a null object.");
				else return null;
			}
		 ...
		 * @return TweenLite instance
		 */
		public static function from(target:Object, duration:Number, vars:Object, ignoreTarget:Boolean = true):TweenLite {
			if(target==null){
				if(!ignoreTarget)  throw new Error("Cannot tween a null object.");
				else return null;
			}	
