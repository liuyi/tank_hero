package com.ourbrander.components.scrollBar{
	...
	*/
	...
	public class ScrollBar extends MovieClip {
		...
		public function setInterface(target:Sprite) :void{//更换滚动条的皮肤
			if (_Skin==null) {
			...
			_Skin=target;
			_upBtn=_Skin.getChildByName("upBtn") as Sprite;
			_downBtn=_Skin.getChildByName("downBtn") as Sprite;
			_bg=_Skin.getChildByName("bg") as Sprite;
			_dragMc=_Skin.getChildByName("dragMc") as Sprite;
			initSkin();
